...
using Random = UnityEngine.Random;
    ...
    private AudioSource skidSource2;
    ...
    private void StartSound()
        ...
        skidSource2 = SetUpEngineAudioSource(skidClip);
...

        {
...

            {
...

                {
                    ...
                    float accFade = Mathf.Abs(m_CarController.verticalInput);
                ...
                float skidFade = Mathf.InverseLerp(0.1f, 0.5f, m_CarController.rearSidewaySlip);
                skidSource.volume = skidFade;

                float skidFade2 = Mathf.InverseLerp(0.6f, 1f, m_CarController.frontForwardSlip);
                skidSource2.volume = skidFade2;
